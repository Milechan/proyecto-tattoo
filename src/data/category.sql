...
('Minimalista', 
 'Un tatuaje minimalista es un diseño sencillo que se caracteriza por líneas limpias, sombreado mínimo y colores sobrios. Son populares por su discreción y elegancia.\nSon fáciles de realizar\nSon ideales para personas que no toleran bien el dolor\nSuelen ser de pequeño tamaño y pueden tener significados profundos y personales', 
...
('Black-Out', 
 'Un tatuaje blackout es un tatuaje que cubre una parte del cuerpo con tinta negra sólida. Esta técnica de tatuaje se ha vuelto popular entre celebridades y deportistas.\nSe pueden tatuar grandes áreas del cuerpo, como brazos, piernas, espalda, pecho o cuello.\nPueden ser una forma de ocultar tatuajes antiguos que ya no se desean.\nPueden crear contrastes audaces con áreas no tatuadas y también pueden incorporar patrones y diseños geométricos.', 
...
('Realismo', 
 'Un tatuaje realista es un diseño que imita de manera fiel la realidad, como si fuera un cuadro. Este estilo de tatuaje se caracteriza por los detalles precisos, las sombras y la reproducción de fotografías.\nSe basa en una imagen de referencia, ya sea una foto o algo natural\nRequiere de una gran habilidad y experiencia por parte del tatuador\nLa calidad del tatuaje depende de la pericia del tatuador y de la calidad de la imagen original\nPuede ser duradero, por lo que es importante elegir bien el diseño', 
